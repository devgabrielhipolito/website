...
const Header = () => {
  ...
  return (
    <header className="fixed w-full bg-near-black border-b border-b-white/10   h-24 z-10  ">
      <div className="w-full flex items-center justify-between  h-24 p-8">
        <Text className="font-jarkarta-sans">Name</Text>
        <Button
          className="cursor-pointer transition-all bg-transparent w-2"
